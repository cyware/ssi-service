...
Created: Nov 2, 2022
Updated: Nov 8, 2022
Discussion: https://forums.cyware.github.io/t/sip-6-presentation-exchange-with-long-running-operations
```
...
1. CYWARE extends an offer to a prospective employee, Andres.
    1. Offer is contingent on the employee proving (or submitting) additional information. 
2. CYWARE defines what proofs they require from Andres. For a simple case, let’s focus only on proof of employment eligibility.
3. CYWARE communicates that they need proof of employment to Andres.
4. Andres gathers this information, and sends it to CYWARE.
5. CYWARE processes the information, deciding whether it’s acceptable or not.
...
Now, for the use case above, we can imagine that CYWARE and Andres both want to very quickly implement these interactions using SSI service. The goal of this document is to provide all the necessary functionality for doing so.
