...
import (
	...
	credsdk "github.com/cyware/ssi-sdk/credential"
	"github.com/cyware/ssi-sdk/credential/manifest"
	"github.com/cyware/ssi-sdk/credential/parsing"
	...
	credmodel "github.com/cyware/ssi-service/internal/credential"
	"github.com/cyware/ssi-service/internal/keyaccess"
	"github.com/cyware/ssi-service/internal/util"
	"github.com/cyware/ssi-service/pkg/server/router"
	"github.com/cyware/ssi-service/pkg/service/credential"
	"github.com/cyware/ssi-service/pkg/service/did"
	"github.com/cyware/ssi-service/pkg/service/issuance"
	manifestsvc "github.com/cyware/ssi-service/pkg/service/manifest/model"
	"github.com/cyware/ssi-service/pkg/service/operation/storage"
	"github.com/cyware/ssi-service/pkg/service/schema"
	"github.com/cyware/ssi-service/pkg/testutil"
)
	...
	for _, test := range testutil.TestDatabases {
		t.Run(test.Name, func(t *testing.T) {
			...
			t.Run("Submit Application With Issuance Template", func(t *testing.T) {
				...
				assert.True(t, strings.HasSuffix(vc.CredentialSchema.ID, licenseSchema.ID))
				...
				assert.True(t, strings.HasSuffix(vc2.CredentialSchema.ID, licenseSchema.ID))
