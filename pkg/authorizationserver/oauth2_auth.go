...
import (
	...
	"github.com/cyware/ssi-sdk/oidc/issuance"
	...
	"github.com/cyware/ssi-service/pkg/authorizationserver/request"
)
	...
	if s.issuerMetadata.AuthorizationServer != nil {
		for i, d := range authorizationDetails {
			...
			case "openid_credential":
				...
				// TODO(https://github.com/cyware/ssi-service/issues/368): support dynamic auth request
