...
import (
	...
	schemalib "github.com/cyware/ssi-sdk/credential/schema"
	statussdk "github.com/cyware/ssi-sdk/credential/status"
	...
	"github.com/cyware/ssi-service/pkg/server/pagination"
...
func (s Service) createCredential(ctx context.Context, request CreateCredentialRequest, tx storage.Tx, statusMetadata StatusListCredentialMetadata) (*CreateCredentialResponse, error) {
	...
	// TODO(gabe) support Data Integrity creds too https://github.com/cyware/ssi-service/issues/105
