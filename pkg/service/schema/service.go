...
import (
	...
	"github.com/cyware/ssi-sdk/credential/schema"
	"github.com/cyware/ssi-sdk/did"
	"github.com/cyware/ssi-sdk/did/resolution"
	schemalib "github.com/cyware/ssi-sdk/schema"
...
func (s Service) GetSchema(ctx context.Context, request GetSchemaRequest) (*GetSchemaResponse, error) {
	...
	// TODO(gabe) support external schema resolution https://github.com/cyware/ssi-service/issues/125
